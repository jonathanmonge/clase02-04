...
public class Cliente implements Serializable {
	...
	private double ultimaNotaObtenidaEnProgramacion2;
	...
	public double getUltimaNotaObtenidaEnProgramacion2() {
		return this.ultimaNotaObtenidaEnProgramacion2;
	}

	public void setUltimaNotaObtenidaEnProgramacion2(double ultimaNotaObtenidaEnProgramacion2) {
		this.ultimaNotaObtenidaEnProgramacion2 = ultimaNotaObtenidaEnProgramacion2;
	}
	...
	public String toString() {
		return "Cliente [id=" + id + ", apellido=" + apellido + ", direccion=" + direccion + ", dui=" + dui + ", edad="
				...
				+ ", nit=" + nit + ", nombre=" + nombre + ", ultimaNotaObtenidaEnProgramacion2="
				+ ultimaNotaObtenidaEnProgramacion2 + "]";
	}
